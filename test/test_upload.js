    ...
    describe("#upload()", function () {
      ...
      it("upload date matrix", async function () {
        await myConnect.upload(
          ...
          DT.Matrix(
            DT.Date([
              ["1973-02-01", "1960-01-01", "1970-01-03"],
              ["1973-02-02", "1960-01-02", "1970-02-03"],
            ])
          )
        );
        let re = await myConnect.run("a");
      ...
      it("upload time matrix", async function () {
        await myConnect.upload(
          ...
          DT.Matrix(
            DT.Time([
              ["13:30:10.009", "12:30:10.010"],
              ["13:30:10.011", "12:30:10.012"],
            ])
          )
        );
        let re = await myConnect.run("a");
        ...
        assert.equal(
          re[1].toString(),
          "13:30:10.11000000ns,12:30:10.12000000ns"
        );
      });
      ...
      it("upload datetime matrix", async function () {
        await myConnect.upload(
          ...
          DT.Matrix(
            DT.DateTime([
              ["2012-06-13 13:30:10", "2012-06-13 13:30:11"],
              ["2012-06-13 13:30:12", "2012-06-13 13:30:13"],
            ])
          )
        );
        let re = await myConnect.run("a");
      ...
      it("upload timestamp matrix", async function () {
        await myConnect.upload(
          ...
          DT.Matrix(
            DT.TimeStamp([
              ["2012-06-13 13:30:10.009", "2012-06-13 13:30:11.008"],
              ["2012-06-13 13:30:11.008", "2012-06-13 13:30:11.009"],
            ])
          )
        );
        let re = await myConnect.run("a");
        ...
        assert.equal(
          re[1].toString(),
          "2012-6-13 13:30:11.8000000ns,2012-6-13 13:30:11.9000000ns"
        );
      });
      it("upload nanotime matrix", async function () {
        await myConnect.upload(
          ...
          DT.Matrix(
            DT.NanoTime([
              ["13:30:10.008007006", "13:30:10.008007007"],
              ["13:30:10.008007007", "13:30:10.008007006"],
            ])
          )
        );
        let re = await myConnect.run("a");
      ...
      it("upload nanotimestamp matrix", async function () {
        ...
        assert.equal(
          re[1].toString(),
          "2012-6-1 13:30:10.8007007ns,2012-6-1 13:30:10.8007008ns"
        );
      });
