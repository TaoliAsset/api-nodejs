  ...
  describe("#DBconnection.js", function () {
    describe("#run()", function () {
      ...
      it("run time vector", async function () {
        const re = await myConnect.run(
          "[13:30:10.008, 13:30:10.009, 13:30:10.010]"
        );
        ...
        assert.equal(
          re.toString(),
          "13:30:10.8000000ns,13:30:10.9000000ns,13:30:10.10000000ns"
        );
      });
      ...
      it("run datetime vector", async function () {
        const re = await myConnect.run(
          "[2012.06.13 13:30:10, 2012.06.13 13:30:11, 2012.06.13 13:30:12]"
        );
        ...
        assert.equal(
          re.toString(),
          "2012-6-13 13:30:10,2012-6-13 13:30:11,2012-6-13 13:30:12"
        );
      });
      ...
      it("run datetime some null vector", async function () {
        const re = await myConnect.run(
          "[2012.06.13 13:30:10, 2012.06.13 13:30:11, datetime()]"
        );
        assert.equal(re[0].get()["year"], 2012);
        assert.equal(re[0].get()["month"], 6);
        assert.equal(re[0].get()["day"], 13);
      ...
      it("run timestamp vector", async function () {
        const re = await myConnect.run(
          "[2012.06.13 13:30:10.008, 2012.06.13 13:30:11.008, 2012.06.13 13:30:12.008]"
        );
        ...
        assert.equal(
          re.toString(),
          "2012-6-13 13:30:10.8000000ns,2012-6-13 13:30:11.8000000ns,2012-6-13 13:30:12.8000000ns"
        );
      });
      ...
      it("run timestamp vector", async function () {
        const re = await myConnect.run(
          "[2012.06.13 13:30:10.008, 2012.06.13 13:30:11.008, timestamp()]"
        );
        assert.equal(re[0].get()["date"]["year"], 2012);
        assert.equal(re[0].get()["date"]["month"], 6);
        assert.equal(re[0].get()["date"]["day"], 13);
        ...
        assert.equal(
          re.toString(),
          "2012-6-13 13:30:10.8000000ns,2012-6-13 13:30:11.8000000ns,"
        );
      });

      it("run nanotime vector", async function () {
        const re = await myConnect.run(
          "[13:30:10.008007006, 13:30:10.008007007, 13:30:10.008007008]"
        );
        assert.equal(re[0].get()["hour"], 13);
        assert.equal(re[0].get()["minute"], 30);
        assert.equal(re[0].get()["second"], 10);
        ...
        assert.equal(
          re.toString(),
          "13:30:10.8007006ns,13:30:10.8007007ns,13:30:10.8007008ns"
        );
      });
      ...
      it("run nanotime some null vector", async function () {
        const re = await myConnect.run(
          "[13:30:10.008007006, 13:30:10.008007007, nanotime()]"
        );
        assert.equal(re[0].get()["hour"], 13);
        assert.equal(re[0].get()["minute"], 30);
        assert.equal(re[0].get()["second"], 10);
      ...
      it("run nanotimestamp vector", async function () {
        const re = await myConnect.run(
          "[2012.06.01 13:30:10.008007006, 2012.06.01 13:30:10.008007007, 2012.06.01 13:30:10.008007008]"
        );
        assert.equal(re[0].get()["date"]["year"], 2012);
        assert.equal(re[0].get()["date"]["month"], 6);
        ...
        assert.equal(
          re.toString(),
          "2012-6-1 13:30:10.8007006ns,2012-6-1 13:30:10.8007007ns,2012-6-1 13:30:10.8007008ns"
        );
      });
      ...
      it("run nanotimestamp some null vector", async function () {
        const re = await myConnect.run(
          "[2012.06.01 13:30:10.008007006, 2012.06.01 13:30:10.008007007, nanotimestamp()]"
        );
        assert.equal(re[0].get()["date"]["year"], 2012);
        assert.equal(re[0].get()["date"]["month"], 6);
        assert.equal(re[0].get()["date"]["day"], 1);
        ...
        assert.equal(
          re.toString(),
          "2012-6-1 13:30:10.8007006ns,2012-6-1 13:30:10.8007007ns,"
        );
      });
      ...
      it("run ipaddr vector", async function () {
        const re = await myConnect.run(
          "ipaddr(['192.168.1.135', '192.168.1.132', '192.168.1.133'])"
        );
