...
class BasicInt128 extends BasicScalar {
  ...
  equals(o) {
    if (!(o instanceof BasicInt128) || o === null) return false;
    else return this.high === o.high && this.low === o.low;
  }
  ...
  toString() {
    if (this.hex128 !== null) return this.hex128;
